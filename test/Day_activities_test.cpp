...
TEST(Day_activities, Add_activity_test) {
    ...
    ASSERT_EQ(Day_activities.front()->get_activity_name(), "run");
    ASSERT_EQ(Day_activities.front()->get_time().get_time_start(), "1:00");
    ASSERT_EQ(Day_activities.front()->get_time().get_time_end(), "10:00");
...
TEST(Day_activities, Remove_activity_test) {
    ...
    ASSERT_EQ(Day_activities.size(), 1);
